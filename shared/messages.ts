...
export interface CastReq { type: 'CastReq'; id: string; skillId: string; targetId?: string; targetPos?: VecXZ; clientTs: number }

export type ClientMsg = MoveStart | MoveSync | CastReq

export interface PosSnap { id: string; pos: VecXZ; vel: VecXZ; ts: number }
export interface CastStart { id: string; skillId: string; castMs: number; }
export interface CastEnd { id: string; skillId: string; success: boolean }
