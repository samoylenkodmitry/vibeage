...
const EFFECT_ICON_SLUGS: Record<EffectType, string> = {
  ...
  marked: 'treasure-sense',
  freeze: 'freeze',
  timeStop: 'freeze',
  shield: 'shield',
  damageReflect: 'shield',
  bless: 'bless',
  arcaneCharge: 'bless',
  dispel: 'dispel',
  taunt: 'taunt',
...
const EFFECT_SPEC_DEFS: Record<EffectType, EffectSpecInput> = {
  ...
  marked: {
    type: 'marked',
    label: 'Marked',
    description: 'Precision marker consumed by follow-up shots for stronger control or burst.',
    category: 'debuff',
    stacking: 'refresh',
  },
  freeze: {
  ...
  timeStop: {
    type: 'timeStop',
    label: 'Time Stop',
    description: 'Suspends movement, casting, and attacks while the duration lasts.',
    category: 'debuff',
    stacking: 'refresh',
  },
  shield: {
  ...
  damageReflect: {
    ...
    description: 'Returns the listed percent of post-mitigation incoming damage to the attacker.',
    category: 'buff',
    valueUnit: '%',
    stacking: 'refresh',
  },
  ...
  arcaneCharge: {
    type: 'arcaneCharge',
    label: 'Arcane Charge',
    description: 'Stacking caster charge consumed by arcane payoffs for extra burst.',
    category: 'buff',
    stacking: 'stack',
    maxStacks: 3,
  },
  ...
  silence: {
    type: 'silence',
    label: 'Silence',
    description: 'Prevents skill casts while allowing movement and basic positioning.',
    category: 'debuff',
    stacking: 'refresh',
  },
  knockback: {
