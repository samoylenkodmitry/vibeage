...
export const VALE_TARN_WATER_Y = 2.6; // a broad tarn: floods the gravel bars into one connected milky-turquoise body (was 0.9 → only the deepest threads held water, the rest read as exposed grey gravel), leaving a beach margin up the floodplain
