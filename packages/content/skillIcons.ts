...
const SKILL_ICON_SLUGS = {
  ...
  phase_prison: 'phase-prison',
  tripwire_volley: 'tripwire-volley',
  guardian_hook: 'guardian-hook',
  lifeline_swap: 'lifeline-swap',
  combustion_bloom: 'combustion-bloom',
  blood_magnet: 'blood-magnet',
  echoing_benediction: 'echoing-benediction',
  umbra_mine: 'umbra-mine',
  vengeance_tether: 'vengeance-tether',
  sunbreak_charge: 'sunbreak-charge',
  tidal_barrier: 'tidal-barrier',
  jackpot_snare: 'jackpot-snare',
  razorwind_step: 'razorwind-step',
  stasis_lattice: 'stasis-lattice',
  blade_reversal: 'blade-reversal',
  sanctuary_gate: 'sanctuary-gate',
  ricochet_prism: 'ricochet-prism',
  bulwark_zone: 'bulwark-zone',
  purifying_mirror: 'purifying-mirror',
  phantom_split: 'phantom-split',
  ember_relay: 'ember-relay',
  seismic_rend: 'seismic-rend',
  harmonic_seal: 'harmonic-seal',
  nightfall_net: 'nightfall-net',
  pain_dividend: 'pain-dividend',
  cinder_halo: 'cinder-halo',
  loaded_mirage: 'loaded-mirage',
