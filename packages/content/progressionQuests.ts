...
export const HIGH_PROGRESSION_QUESTS: Record<string, QuestDef> = {
  sunspire_firebreak: {
    ...
    reward: { xp: 11_000, gold: 3_200, items: [{ itemId: 'firebreak_sash', quantity: 1 }, { itemId: 'fire_gem', quantity: 5 }] },
  },
  moonfall_star_chart: {
    ...
    reward: { xp: 13_500, gold: 3_800, items: [{ itemId: 'starward_visor', quantity: 1 }, { itemId: 'star_essence', quantity: 3 }] },
  },
  marsh_silence_pact: {
    ...
    reward: { xp: 16_000, gold: 4_500, items: [{ itemId: 'marshward_boots', quantity: 1 }, { itemId: 'abyssal_pearl', quantity: 2 }] },
  },
  zero_hour_breach: {
    id: 'zero_hour_breach',
    ...
    reward: { xp: 20_000, gold: 5_600, items: [{ itemId: 'zero_hour_loop', quantity: 1 }, { itemId: 'temporal_shard', quantity: 4 }] },
  },
};
