...
export const SPEC_AND_PROFICIENCY_SKILLS: Partial<Record<SkillId, SkillDef>> = {
  ...
  rewind_mark: {
    ...
    manaCost: 45, castMs: 0, cooldownMs: 45000, levelRequired: 40, isBlocking: false, selfTarget: true,
  ...
  mirror_spell: {
    ...
    manaCost: 45, castMs: 0, cooldownMs: 32000, levelRequired: 40, isBlocking: false, selfTarget: true,
  ...
  soul_link: {
    ...
    manaCost: 50, castMs: 500, cooldownMs: 24000, range: 18, levelRequired: 40, requiresTarget: true,
  ...
  phase_step: {
    ...
    icon: '/game/skills/skill-icon-shadow-strike.png', cat: 'instant', kind: 'physical',
    manaCost: 35, castMs: 0, cooldownMs: 16000, range: 14, levelRequired: 40, requiresTarget: true, isBlocking: false,
  ...
  projectile_capture: {
    ...
    icon: '/game/skills/skill-icon-holy-shield.png', cat: 'instant', kind: 'utility',
    manaCost: 45, castMs: 0, cooldownMs: 30000, levelRequired: 40, isBlocking: false, selfTarget: true,
  ...
  puppet_mastery: {
    ...
    icon: '/game/skills/skill-icon-soul-eater.png', cat: 'instant', kind: 'magical',
    manaCost: 50, castMs: 700, cooldownMs: 28000, range: 16, levelRequired: 40, requiresTarget: true,
  ...
  momentum_strike: {
    ...
    icon: '/game/skills/skill_melee.svg', cat: 'instant', kind: 'physical',
    manaCost: 35, castMs: 0, cooldownMs: 14000, range: 5, levelRequired: 40, requiresTarget: true, isBlocking: false,
  ...
  delayed_fate: {
    ...
    icon: '/game/skills/skill-icon-arcane-supremacy.png', cat: 'instant', kind: 'magical',
    manaCost: 45, castMs: 400, cooldownMs: 22000, range: 20, levelRequired: 40, requiresTarget: true,
  ...
  clone_swap: {
    ...
    icon: '/game/skills/skill-icon-shadow-strike.png', cat: 'instant', kind: 'physical',
    manaCost: 40, castMs: 0, cooldownMs: 24000, range: 14, levelRequired: 40, requiresTarget: true, isBlocking: false,
    role: 'mobility', school: 'shadow', scalingStat: 'dex', targetMode: 'enemy', pveUse: ['opener', 'escape'],
  ...
  silence_bubble: {
    ...
    icon: '/game/skills/skill-icon-group-bless.png', cat: 'aura', kind: 'utility',
    manaCost: 55, castMs: 400, cooldownMs: 28000, range: 18, area: 6, levelRequired: 40, requiresTarget: true,
  ...
  reflection_contract: {
    ...
    icon: '/game/skills/skill-icon-holy-shield.png', cat: 'instant', kind: 'utility',
    manaCost: 50, castMs: 0, cooldownMs: 42000, levelRequired: 40, isBlocking: false, selfTarget: true,
    role: 'tank', school: 'shadow', scalingStat: 'con', targetMode: 'self', pveUse: ['sustain', 'boss'],
