...
export const SKILL_IDS = [
  ...
  'mobStrike', 'mobPoisonBite', 'mobFirebolt', 'mobFrostbolt', 'mobBreath', 'mobWarbandHowl', 'mobBrambleSnare', 'mobLatticeMark', 'mobSeismicSlam', 'mobTimeSnare', 'mobCleave', 'mobFlankStrike', 'mobMendPack',
