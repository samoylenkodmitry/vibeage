...
export type SkillId =
  ...
  | 'passive_arcane_focus'|'passive_battle_hardened'|'passive_serenity'|'passive_woodland_step'
  | 'passive_iron_discipline'|'passive_oath_of_light'|'passive_shadow_strike'
  | 'passive_toughness'|'passive_brutality'|'passive_focus_mind'|'passive_arcane_potency'
  | 'passive_serene_mind'|'passive_warding'|'passive_keen_eye'|'passive_swift_step'
  | 'passive_armor_training'|'passive_iron_grip'|'passive_holy_aegis'|'passive_radiant_focus'
