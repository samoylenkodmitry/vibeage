...
const GEAR: BossGearDef[] = [
  ...
  },
  {
    ...
    equip: {
      ...
      icon: 'fogbound_cloak.svg', stackable: false, type: 'armor', kind: 'armor', grade: 'c', weight: 1200, setId: 'veiled_mantle',
  ...
  },
  {
    ...
    equip: {
      ...
      icon: 'vinebound_bow.svg', stackable: false, type: 'weapon', kind: 'weapon', grade: 'b', weight: 1900, setId: 'worldspine_regalia',
