...
const SPECIALIZATION_AI_IDENTITIES: Record<SpecializationId, SpecializationAiIdentity> = {
  ...
  evas_templar: { plan: 'Cleanse first, layer shields, and keep holy pressure while allies stabilize.', desiredRangeFraction: 0.62, priorityTactics: ['defensive', 'sustain', 'control'] },
...
export const SPECIALIZATION_AI_PROFILES: Record<SpecializationId, SpecializationAiProfile> = {
  ...
  pyromancer: profile('pyromancer', 'burst', [
    ...
    enemy('inferno_aura', { targetMissingEffect: 'burn' }, undefined, 'opener'),
  ...
  berserker: profile('berserker', 'sustain', [
    self('blood_magnet', { casterMissingEffect: 'attackSpeed' }, 'sustain'),
    self('blood_frenzy', { casterMissingEffect: 'attackSpeed' }, 'opener'),
    self('blood_frenzy', { casterMissingEffect: 'bless' }, 'sustain'),
    self('rage', { casterMissingEffect: 'bless' }, 'sustain'),
    ...
    enemy('slash', { targetMissingEffect: 'dot' }, undefined, 'opener'),
    enemy('powerStrike'),
  ]),
  ...
  cardinal: profile('cardinal', 'support', [
    ...
    self('greater_heal', { casterHealthBelowPct: 0.82 }, 'sustain'),
    self('holyLight', { casterHealthBelowPct: 0.9 }, 'sustain'),
    self('bless', { casterMissingEffect: 'bless' }, 'sustain'),
    enemy('soul_link'),
    enemy('smite', undefined, undefined, 'filler'),
  ]),
  theurge: profile('theurge', 'support', [
    self('group_bless', { casterMissingEffect: 'bless' }),
    self('group_bless', { casterMissingEffect: 'attackSpeed' }, 'opener'),
    self('mirror_spell'),
  ...
  phantom_ranger: profile('phantom_ranger', 'skirmish', [
    ...
    enemy('shadow_arrow', { targetHasEffect: 'poison' }, undefined, 'combo'),
    enemy('phase_step'),
    enemy('shadow_arrow'),
    self('rapidFire', { casterMissingEffect: 'attackSpeed' }),
  ...
  templar_knight: profile('templar_knight', 'tank', [
    ...
    self('holy_shield', { casterMissingEffect: 'shield' }, 'sustain'),
    enemy('silence_bubble'),
    enemy('divine_taunt', { targetMissingEffect: 'taunt' }, undefined, 'control'),
    enemy('taunt'),
  ...
  dark_avenger: profile('dark_avenger', 'sustain', [
    ...
    enemy('vengeance_tether', { targetMissingEffect: 'taunt' }, undefined, 'control'),
  ...
  phoenix_knight: profile('phoenix_knight', 'tank', [
    ...
    enemy('sunbreak_charge', { casterMissingEffect: 'shield' }, undefined, 'opener'),
    enemy('phoenix_leap', { casterMissingEffect: 'shield' }, undefined, 'opener'),
    self('divineShield', { casterHealthBelowPct: 0.65, casterMissingEffect: 'shield' }),
    self('holyLight', { casterHealthBelowPct: 0.7 }, 'sustain'),
    enemy('phoenix_leap'),
    enemy('smite', undefined, undefined, 'filler'),
  ]),
  evas_templar: profile('evas_templar', 'support', [
    ...
    self('sacred_aura', { casterMissingEffect: 'shield' }, 'sustain'),
