...
// Note: Grakk's Warband Howl was retyped from a circle to a
// summonPack mechanic in the archwork #6 follow-up sweep. Coverage
// for the new behaviour lives in tests/bossMechanicSummonPack.spec.ts.
