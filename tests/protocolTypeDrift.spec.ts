...
describe('protocol type ↔ schema drift', () => {
  ...
  it('ServerMessage TS union literals all parse as some serverMessageSchema variant', () => {
    ...
    const minimal: Record<string, Record<string, unknown>> = {
      ...
      PhysicsFieldSnapshot: { field: { id: 'f', kind: 'timeStop', sourceSkill: 'time_sphere', casterId: 'p', origin: { x: 0, z: 0 }, radius: 8, startTimeTs: 0, durationMs: 3500 } },
      ...
      CastInterrupted: { castId: 'c', casterId: 'e', casterName: 'B', skillId: 'mobCleave', abilityName: 'Cleave', reason: 'stun' },
