...
const PLAYER_SKILL_EXPECTATIONS: Record<string, SkillExpectation> = {
  ...
  arcane_supremacy: { effects: ['damage', 'marked'], targetMode: 'enemy', reactionIds: ['arcane_overflow'] },
  ...
  inferno_aura: { effects: ['damage', 'burn'], targetMode: 'area-self', area: true },
  blood_frenzy: { effects: ['bless', 'attackSpeed', 'speed_boost'], targetMode: 'self' },
  killing_strike: { effects: ['damage'], targetMode: 'enemy', offenseKeys: ['executeBonus', 'bonusCritChance'], reactionIds: ['execution_window'] },
  mass_heal: { effects: ['heal', 'shield', 'dispel'], targetMode: 'area-self', area: true },
  group_bless: { effects: ['bless', 'attackSpeed'], targetMode: 'area-self', area: true },
  waygate: { effects: ['speed_boost', 'aggroReset'], targetMode: 'area-self', area: true },
  aimed_volley: { effects: ['damage', 'slow'], targetMode: 'enemy', area: true, reactionIds: ['kill_zone'] },
  shadow_arrow: { effects: ['damage', 'poison'], targetMode: 'enemy', offenseKeys: ['armorPen'] },
  divine_taunt: { effects: ['taunt'], targetMode: 'enemy', area: true },
  ...
  rebirth: { effects: ['shield', 'heal', 'bless'], targetMode: 'self' },
  sacred_aura: { effects: ['heal', 'shield'], targetMode: 'area-self', area: true },
  treasure_sense: { effects: ['reveal_loot', 'evasion', 'speed_boost'], targetMode: 'self' },
  stalking_arrow: { effects: ['damage', 'marked', 'slow', 'poison'], targetMode: 'enemy', reactionIds: ['venom_tracking'] },
