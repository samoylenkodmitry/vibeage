...
export type DayPhaseSlice = { label: 'Dawn' | 'Day' | 'Dusk' | 'Night'; icon: string };
 ...
 * Exported so tests can pin the boundaries without spinning up the
 * Chip component (no DOM in the unit test runner).
 */
export function phaseToSlice(phase: number): DayPhaseSlice {
